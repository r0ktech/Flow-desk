      ...
      <div className="flex flex-col lg:flex-row gap-6">
              ...
              return (
                ...
                >
                  <Icon
                    className={clsx(
                      "w-4 h-4",
                      active === s.key ? "text-indigo-500" : "text-slate-400",
                    )}
                  />
        ...
        <div className="flex-1 min-w-0 space-y-5">
          {active === "profile" && (
            <Section
              title="Profile"
              description="Information about you and how it appears across Flowdesk."
            >
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-slate-800">
                  ...
                  <div className="flex items-center gap-2">
                    <Button variant="ghost" size="sm" disabled={!profileDirty}>
                      Discard
                    </Button>
                    <Button
                      variant="primary"
          ...
          {active === "workspace" && (
            <Section
              title="Workspace"
              description="Information about your organization and how your team uses Flowdesk."
            >
              <div className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <Field
                  ...
                  <Field
                    label="Workspace URL"
                    hint="Your custom Flowdesk domain"
                  >
                    <div className="relative">
                      <Input
                        value={workspace.url}
                        onChange={(v) => setWorkspace({ ...workspace, url: v })}
                  ...
                  <Field
                    ...
                    hint="Used for schedules and reports"
                  >
                    <select
                      ...
                      className="w-full h-9 px-3 rounded-md text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-[#2c9b7a]"
                    >
                      {[
                  ...
                  <Field
                    ...
                    hint="Language for emails and UI"
                  >
                    <select
                      defaultValue="en-US"
                      className="w-full h-9 px-3 rounded-md text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-[#2c9b7a]"
                ...
                <div className="rounded-lg border border-amber-200 dark:border-amber-900/60 bg-amber-50/60 dark:bg-amber-950/30 p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] text-amber-700/80 dark:text-amber-300/80 mt-0.5 mb-2">
                      ...
                      tickets, customers, and team data. This action cannot be
                      undone.
                    </div>
                ...
                <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                  ...
                  <Button variant="primary" size="sm" onClick={saveWorkspace}>
                    Save changes
                  </Button>
                </div>
              </div>
          ...
          {active === "notifications" && (
            <Section
              title="Notifications"
              description="Decide what updates and activities you want to receive."
            >
                ...
                <div className="p-4 flex items-start justify-between gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                        Receive updates about tickets, mentions, and activity
                        via email.
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-4 flex items-start justify-between gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                        Receive push notifications directly to your desktop when
                        Flowdesk is open.
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-4 flex items-start justify-between gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                        Get notified when a new ticket is assigned to you or to
                        your team.
                      </div>
                    </div>
                  </div>
                  <Toggle
                    ...
                    onChange={(v) =>
                      setNotifications({ ...notifications, assignment: v })
                    }
                  />
                </div>
                <div className="p-4 flex items-start justify-between gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                        Be notified when someone mentions you in notes or
                ...
                <div className="p-4 flex items-start justify-between gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                        Get a summary of your team's performance delivered every
                        Monday morning.
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-4 flex items-start justify-between gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                        Occasionally receive emails about new features and
          ...
          {active === "appearance" && (
            <Section
              title="Appearance"
              description="Customize how Flowdesk looks on your device. Changes sync across browsers."
            >
              <div>
                <div className="text-xs font-medium text-slate-700 dark:text-slate-200 mb-3">
                  Theme
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {[
                    ...
                    },
                    {
                      ...
                      icon: Monitor,
                      preview:
                        "bg-gradient-to-br from-white via-slate-100 to-slate-900 border-slate-300",
                      accent: "bg-slate-500",
                    },
                  ].map((t) => {
                    const Icon = t.icon;
                    ...
                    return (
                      ...
                      >
                        <div
                          className={clsx(
                            "h-24 rounded-lg border p-2 overflow-hidden mb-3",
                            t.preview,
                          )}
                        >
                        ...
                        <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5 pl-6">
                          {t.desc}
                        </div>
                      </button>
                    );
                  ...
                  {[
                    {
                      key: "compact",
                      label: "Compact",
                      desc: "More content, less spacing",
                    },
                    {
                      key: "comfortable",
                      label: "Comfortable",
                    ...
                    },
                    {
                      key: "spacious",
                      label: "Spacious",
                      desc: "Larger targets and padding",
                    },
                  ].map((t, i) => (
                    <button
                      key={t.key}
              ...
              <div className="mt-8 rounded-lg bg-slate-50/70 dark:bg-slate-950/40 border border-slate-100 dark:border-slate-800 p-4 text-xs text-slate-500 dark:text-slate-400 flex items-center gap-2">
                ...
                Appearance preferences are saved locally and applied to this
