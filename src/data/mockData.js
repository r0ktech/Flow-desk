...
export const tickets = [
  ...
  { id: 'T-1043', customerId: 'c2', customer: 'Marcus Weber', subject: 'Zendesk migration import failing on attachments', status: 'Open', priority: 'High', assigneeId: 'u3', assignee: 'Jordan Kim', createdAt: hoursAgo(5), updatedAt: hoursAgo(5), channel: 'email', category: 'Technical', tags: ['migration', 'zendesk', 'attachments'], description: 'Started Zendesk import about 2 hours ago. Tickets and comments imported but all attachments failed with a generic "blob upload error". Approximately 1,200 files affected.' },
  { id: 'T-1044', customerId: 'c16', customer: 'Omar Farouk', subject: 'Weekly digest email going to spam folder', status: 'Pending', priority: 'Low', assigneeId: 'u5', assignee: 'Liam O\'Brien', createdAt: daysAgo(1), updatedAt: daysAgo(1), channel: 'chat', category: 'Bug Report', tags: ['email', 'deliverability', 'spam'], description: 'Our entire team reports that the weekly digest is landing in Gmail spam. Headers show SPF passes but DKIM is failing for the flowdesk-notifications.co domain.' },
  { id: 'T-1045', customerId: 'c9', customer: 'Sofia Lindqvist', subject: 'API pagination cursor expires too quickly', status: 'In Progress', priority: 'Medium', assigneeId: 'u2', assignee: 'Maya Patel', createdAt: hoursAgo(14), updatedAt: hoursAgo(10), channel: 'email', category: 'Technical', tags: ['api', 'pagination', 'performance'], description: 'We are syncing ticket data to our data warehouse nightly. Cursors expire after 5 minutes but the job takes 20+ minutes on large datasets. Need longer cursor TTL or a different pagination strategy.' },
];
