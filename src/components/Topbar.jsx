  ...
  return (
    <div className="fixed inset-0 z-[60] overflow-y-auto">
      ...
      <div className="relative min-h-screen flex items-start justify-center pt-[10vh] p-4">
        <div
          className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-xl shadow-2xl ring-1 ring-black/5 dark:ring-white/5 animate-slide-up overflow-hidden"
        ...
        >
          <div className="flex items-center gap-2.5 px-4 h-14 border-b border-slate-200 dark:border-slate-800">
            ...
            <button
              onClick={onClose}
              className="sm:hidden p-1 -mr-1 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
            ...
            {!query ? (
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mt-4 max-w-md mx-auto">
                  {[
                    ...
                    return (
                      <div
                        key={i.label}
                        className="rounded-lg border border-slate-200 dark:border-slate-800 p-3 text-left"
                      >
              ...
              <>
                {filteredTickets.length > 0 && (
                  <div className="mb-2">
                    <div className="px-3 py-1.5 text-[11px] font-medium uppercase tracking-wide text-slate-500 dark:text-slate-400">
                      Tickets
                    </div>
                    {filteredTickets.map((t) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="mt-0.5 text-sm text-slate-900 dark:text-slate-100 truncate">
                            {t.subject}
                          </div>
                        </div>
                      </button>
          ...
          <div className="flex items-center justify-between px-4 py-2.5 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
            <div className="flex items-center gap-4 text-[11px] text-slate-500 dark:text-slate-400">
              <span className="flex items-center gap-1">
                <kbd className="px-1 py-0.5 rounded bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                  ↑↓
                </kbd>{" "}
                Navigate
              </span>
    ...
    <Dropdown
      ...
      trigger={
        <button className="group inline-flex items-center gap-2 h-9 pl-2.5 pr-2 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 max-w-[260px]">
          <div className="w-7 h-7 rounded-md bg-[#153f35] text-[#d9f5e9] flex items-center justify-center flex-shrink-0">
      ...
      items={[
        ...
        ...workspaces.map((w) => ({
          ...
          onClick: () => {},
          icon: w.current ? (
            <CheckCircle className="w-4 h-4 text-[#2c9b7a]" />
          ) : (
      ...
      <header className="sticky top-0 z-30 h-14 bg-white dark:bg-slate-950/80 backdrop-blur border-b border-slate-200 dark:border-slate-800 flex-shrink-0">
        <div className="h-full px-4 lg:px-6 flex items-center gap-3 md:gap-4">
          ...
          <div className="lg:hidden flex-shrink-0">
            <div className="w-8 h-8 rounded-md bg-[#153f35] text-[#d9f5e9] flex items-center justify-center">
              <Building2 className="w-4 h-4" />
            </div>
          </div>
          <div className="hidden md:block flex-1 max-w-xl">
            ...
            >
              ...
              <span className="text-sm text-slate-500 dark:text-slate-400 flex-1 text-left">
                Search tickets, customers, conversations...
              </span>
          ...
          <div className="flex items-center gap-1 ml-auto">
            ...
            <Dropdown
              ...
              trigger={
                <button
                  className="relative h-9 w-9 flex items-center justify-center rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 transition-colors"
