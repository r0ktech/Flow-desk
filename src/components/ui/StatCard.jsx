...
export default function StatCard({
  ...
  return (
    <div
      className={clsx(
        "bg-white/90 dark:bg-[#18201e] rounded-[7px] border p-5 shadow-[0_1px_2px_rgba(23,32,30,0.03)]",
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="mt-2 flex items-baseline gap-1">
            ...
            {suffix && (
              <span className="text-lg text-slate-500 dark:text-slate-400 tabular-nums">
                {suffix}
              </span>
            )}
          </div>
            ...
            <Sparkline
              ...
              positive={
                previous === undefined
                  ...
                  : positive
                    ? true
                    : value < (suffix.includes("%") ? 100 : Infinity)
              }
            />
          </div>
        )}
