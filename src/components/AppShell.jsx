...
export default function AppShell({ children }) {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[#f7f8f6] dark:bg-[#101514] text-[#17201e] dark:text-[#f3f5f2]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main
          className={clsx(
            "flex-1 overflow-y-auto scrollbar-thin min-w-0 app-grid",
          )}
        >
